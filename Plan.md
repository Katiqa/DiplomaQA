...
2.  **Используемое тестовое окружение, и его настройка**:  PC Ubuntu 20.04.5,  Среда разработки "Android studio Koala", Эмулятор Android API 29, Pixel 2, 1080x1920 420 ppi, Установка на эмулятор приложения.
